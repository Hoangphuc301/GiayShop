...
ADD MaXacNhan NVARCHAR(10),
    ThoiGianTaoOTP DATETIME NULL,
...
(N'Nguyễn Hoàng Phúc', 8, '0901234567', N'Hồ Chí Minh');
...
(N'Đen'),(N'Trắng'), (N'Xám'),(N'Xanh dương'),
(N'Xanh lá'), (N'Đỏ'), (N'Vàng'), (N'Nâu'),
(N'Hồng'), (N'Be'), (N'Tím'), (N'Cam');
GO
...
VALUES (1, 1, NULL, 2500000, N'CHỜ XÁC NHẬN', N'Đà Nẵng', '0911111111', 30000, 2530000)
GO
